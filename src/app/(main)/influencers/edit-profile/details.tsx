...
const Details = ({}) => {
  const { session, update, profile, refreshProfile } = useAuthInfluencer();
  ...
  const onSubmitAvatar = async (values: AvatarBody) => {
    ...
    try {
      ...
      if (res.data) {
        ...
        refreshProfile().then(() => toast.success('Cập nhật ảnh đại diện thành công'));
      }
    } catch (err: any) {
                  ...
                  <FormField
                    ...
                    render={() => (
                      <FormItem className="flex flex-col items-center justify-center gap-4 my-auto">
                        <FormControl>
                          <AvatarUploader defaultSrc={profile.avatar} {...avatarRef} />
                        </FormControl>
                        <FormMessage />
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <SelectContent defaultValue={profile.gender}>
